...
var detectPlatform = function() {//Detects on which platform application is running
    ...
    var userAgent = '';
    if (typeof(window) != 'undefined' && window.navigator && navigator.userAgent) {
    ...
    if ( userAgent.indexOf('android') != -1
        ...
        if (userAgent.indexOf('nook') != -1) {
            ui.features.fontIcons = false;
            ui.features.eink = true;
            CURRENT_PLATFORM_EINK = true;
        };
...
var CURRENT_PLATFORM_EINK = false;
